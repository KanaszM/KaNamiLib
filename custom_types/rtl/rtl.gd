...
func newlines_before_and_after(before: int = DEFAULT_NEWLINES_COUNT, after: int = DEFAULT_NEWLINES_COUNT) -> RTL:
	_newlines_before = before
	_newlines_after = after
	return self
