...
@export var value: bool: set = _set_value
#endregion
...
func _init(name_arg: String = "", default_value_arg: bool = false) -> void:
	super._init(Type.BOOL, name_arg)
